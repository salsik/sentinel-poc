...
if not DATA.exists():
    st.error("Missing data/sample_sites.csv. Run: python src/sample_data_generator.py")
    st.stop()
...
with left:
    ...
    selected = st.selectbox("Select site", df["name"].tolist())
